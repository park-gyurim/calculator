...
public class FunctionController implements Initializable {
	...
	@FXML // 할인율 계산기 새창 여는 액션
	public void saleView(ActionEvent event) {
		try {
			AnchorPane saleView = FXMLLoader.load(getClass().getResource("Sale.fxml"));
	...
	@FXML // 비만도 측정기 새창 여는 액션
	public void dietView(ActionEvent event) {
		try {
			AnchorPane dietView = FXMLLoader.load(getClass().getResource("Diet.fxml"));
			Stage primaryStage = (Stage) menubar.getScene().getWindow();

			Stage dialog = new Stage(StageStyle.UTILITY);
			dialog.initModality(Modality.WINDOW_MODAL);
			dialog.initOwner(primaryStage);
			dialog.setTitle("비만도 측정");

			Scene scene = new Scene(dietView);
			dialog.setScene(scene);
			dialog.setResizable(false);
			dialog.show();
	...
	@FXML // 급여 계산기 새창 여는 액션
	public void salaryView(ActionEvent event) {
		try {
			AnchorPane salaryView = FXMLLoader.load(getClass().getResource("Salary.fxml"));
			Stage primaryStage = (Stage) menubar.getScene().getWindow();

			Stage dialog = new Stage(StageStyle.UTILITY);
			dialog.initModality(Modality.WINDOW_MODAL);
			dialog.initOwner(primaryStage);
			dialog.setTitle("급여 계산기");
			
			Scene scene = new Scene(salaryView);
			dialog.setScene(scene);
			dialog.setResizable(false);
			dialog.show();
